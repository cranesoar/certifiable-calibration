...
%
function sensor2_expressedIn_prevSensor2_dq = TransformDiffDualQuat(sensor2_expressedIn_sensor1_dq, sensor1_expressedIn_prevSensor1_dq)

    sensor2_expressedIn_prevSensor2_dq = ConcatDualQuat(ConcatDualQuat(InverseDualQuat(sensor2_expressedIn_sensor1_dq), sensor1_expressedIn_prevSensor1_dq), sensor2_expressedIn_sensor1_dq);
