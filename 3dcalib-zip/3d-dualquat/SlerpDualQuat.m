...
%
function r = SlerpDualQuat(p,q,t)

    log_diff = LogDualQuat(ConcatDualQuat(InverseDualQuat(p), q));
    
    scaled_log_diff = bsxfun(@times, log_diff, t);

    r = ConcatDualQuat(p, ExpDualQuat(scaled_log_diff));