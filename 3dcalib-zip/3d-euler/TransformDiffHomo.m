...
%
function sensor2_expressedIn_prevSensor2 = TransformDiffHomo(sensor2_expressedIn_sensor1, sensor1_expressedIn_prevSensor1)
    ...
    for i = 1:size(sensor1_expressedIn_prevSensor1,1)
        sensor2_expressedIn_prevSensor2(i,:) = GetState( sensor1_expressedIn_sensor2 * GetHomoTransform(sensor1_expressedIn_prevSensor1(i,:)) * sensor2_expressedIn_sensor1 );
    end